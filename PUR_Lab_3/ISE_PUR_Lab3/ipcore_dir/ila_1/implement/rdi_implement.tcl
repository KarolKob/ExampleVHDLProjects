...
add_files -norecurse -scan_for_includes {../../ila_1.ngc}
add_files -norecurse {../example_design/example_ila_1.vhd}
set_property top example_ila_1 [current_fileset]
import_ip -file {chipscope_icon.xco} -name chipscope_icon
generate_target { all } [get_ips chipscope_icon]
set_property target_constrs_file {../example_design/example_ila_1.xdc} [current_fileset -constrset]
read_xdc -cell ILA_inst ../../ila_1.constraints/ila_1.xdc
synth_design
place_design
route_design
