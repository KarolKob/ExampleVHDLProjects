...
ngdbuild -uc ..\..\example_design\example_ila_1.ucf -p xc3s500e-fg320-4 -sd . example_ila_1.ngc example_ila_1.ngd
REM Check Results
...
REM Run map
ECHO 'Running MAP'
map -w -p xc3s500e-fg320-4 -o example_ila_1.map.ncd example_ila_1.ngd
REM Check Results
